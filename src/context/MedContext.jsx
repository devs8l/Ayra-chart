...
const MedContextProvider = (props) => {
  ...
  const [isSummaryBoxSelected, setIsSummaryBoxSelected] = useState(false);
  const [isAllergysBoxSelected, setIsAllergiesBoxSelected] = useState(false);


  const [activeSummaryData, setActiveSummaryData] = useState(null);

  useEffect(() => {
    setIsContentExpanded(!isUserSelected)
  }, [isUserSelected]);
  ...
  //summary connecting to the chat
  const [isSummaryClicked, setIsSummaryClicked] = useState("");
  ...
  const value = {
    ...
    transcriptText,
    setTranscriptText,
    isSummaryBoxSelected,
    setIsSummaryBoxSelected,
    isAllergysBoxSelected,
    setIsAllergiesBoxSelected,
    //summary box
    activeSummaryData, 
