...
const DatePicker = () => {
  ...
  const { selectedDate, setSelectedDate, isUserSelected, setIsUserSelected ,isCalendarOpen, setIsCalendarOpen} = useContext(MedContext);
  ...
  return (
    <div className="relative">
      <div className="flex items-center gap-2 sm:gap-4 border border-[#22283633] text-xs sm:text-sm text-[#000000b2]   rounded-sm px-1 sm:px-2">
        <button
      ...
      {isCalendarOpen && (
        <div className="absolute mt-2 bg-white border-1 border-gray-100 rounded-2xl shadow-lg p-2 sm:p-4 !z-[1000]">
