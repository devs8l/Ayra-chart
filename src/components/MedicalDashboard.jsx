    ...
    <div className="flex flex-col h-full overflow-y-auto p-6 space-y-6 ">
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div className='bg-gray-50 flex flex-col p-4 rounded-l-2xl rounded-t-2xl relative'>
          <div onClick={()=>handleSummaryClick(patientData,'Clinical Overview')} className='absolute bottom-[-40px] p-3 right-0 bg-gray-50 rounded-b-xl'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
          {bloodEssentials.map((item, index) => (
            <div key={index} className={`p-4 rounded-t-2xl mb-13 rounded-l-2xl relative ${item.status === 'critical' ? 'bg-red-50 ' : 'bg-[#43A55F0D] '}`}>
              <div onClick={()=>handleSummaryClick(item,'Blood Essentials')} className={`absolute bottom-[-47px] p-3 right-0 bg-gray-50 rounded-b-xl`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M6.4 18L5 16.6L14.6 7H6V5H18V17H16V8.4L6.4 18Z" fill="#3472C9" />
                </svg>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {medications.map((med, index) => (
            <div key={index} className="p-4 bg-gray-50 mb-10 rounded-l-2xl rounded-t-2xl relative">
              <div onClick={()=>handleSummaryClick(med,'Chemotherapy Medications')} className='absolute bottom-[-40px] p-3 right-0 bg-gray-50 rounded-b-xl'>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M6.4 18L5 16.6L14.6 7H6V5H18V17H16V8.4L6.4 18Z" fill="#3472C9" />
                </svg>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {vitals.map((vital, index) => (
            <div key={index} className="p-4 bg-[#43A55F0D] rounded-t-2xl rounded-l-2xl relative">
              <div onClick={() => handleSummaryClick(vital, 'Vitals Overview')} className='absolute bottom-[-45px] p-3 right-0 bg-gray-50 rounded-b-xl'>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M6.4 18L5 16.6L14.6 7H6V5H18V17H16V8.4L6.4 18Z" fill="#3472C9" />
                </svg>
              </div>
              ...
              <div className="flex items-center justify-between">
                {/* <div className="flex space-x-2">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M1.33594 12.6668V10.6668H11.3359V12.6668H1.33594ZM12.0026 12.6668V10.6668H13.0026V12.6668H12.0026ZM13.6693 12.6668V10.6668H14.6693V12.6668H13.6693ZM12.0026 10.0002V9.1335C12.0026 8.70016 11.8748 8.36961 11.6193 8.14183C11.3637 7.91405 11.0582 7.80016 10.7026 7.80016H9.66927C9.04705 7.80016 8.51927 7.5835 8.08594 7.15016C7.6526 6.71683 7.43594 6.18905 7.43594 5.56683C7.43594 4.94461 7.6526 4.41683 8.08594 3.9835C8.51927 3.55016 9.04705 3.3335 9.66927 3.3335V4.3335C9.33594 4.3335 9.04705 4.45016 8.8026 4.6835C8.55816 4.91683 8.43594 5.21127 8.43594 5.56683C8.43594 5.92239 8.55816 6.21683 8.8026 6.45016C9.04705 6.6835 9.33594 6.80016 9.66927 6.80016H10.7026C11.3248 6.80016 11.8637 7.00016 12.3193 7.40016C12.7748 7.80016 13.0026 8.30016 13.0026 8.90016V10.0002H12.0026ZM13.6693 10.0002V8.50016C13.6693 7.76683 13.4137 7.1335 12.9026 6.60016C12.3915 6.06683 11.7582 5.80016 11.0026 5.80016V4.80016C11.3359 4.80016 11.6248 4.67794 11.8693 4.4335C12.1137 4.18905 12.2359 3.90016 12.2359 3.56683C12.2359 3.2335 12.1137 2.94461 11.8693 2.70016C11.6248 2.45572 11.3359 2.3335 11.0026 2.3335V1.3335C11.6248 1.3335 12.1526 1.55016 12.5859 1.9835C13.0193 2.41683 13.2359 2.94461 13.2359 3.56683C13.2359 3.88905 13.1748 4.18072 13.0526 4.44183C12.9304 4.70294 12.7693 4.94461 12.5693 5.16683C13.1915 5.45572 13.697 5.90016 14.0859 6.50016C14.4748 7.10016 14.6693 7.76683 14.6693 8.50016V10.0002H13.6693Z" fill="#222836" fill-opacity="0.4" />
                  </svg>
                </div> */}
